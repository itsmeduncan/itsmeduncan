...
Previously Chief AI Officer & CTO at [BuildOps](https://buildops.com) ($1B unicorn). Scaled Weedmaps from 30 to 300+ engineers through a NASDAQ IPO. Led ShopKeep through a $550M acquisition by Lightspeed.

### What I'm Thinking About

- Why [models are the depreciating asset](https://itsmeduncan.com/2026/07/29/the-depreciating-asset/) and the interface is the moat
- What it took to give my agents [a memory that can't leak](https://itsmeduncan.com/2026/07/21/i-gave-my-agents-a-memory-that-cant-leak/)
- Why, looking back, [the org chart is the product](https://itsmeduncan.com/2026/07/07/the-org-chart-is-the-product/)
